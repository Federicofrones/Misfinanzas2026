...
export default function ReconcilePage() {
    ...
    return (
        <div className="space-y-8 pb-12 relative overflow-hidden">
            ...
            <div>
                <h1 className="text-3xl font-bold font-outfit">Conciliación</h1>
                <p className="text-muted-foreground">¿Quién le debe a quién? Las cuentas claras conservan la relación.</p>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                <Card className="border-border/40 bg-card/50 backdrop-blur-sm shadow-xl">
                    <CardHeader className="pb-4">
                        ...
                        <CardDescription>Resumen de los gastos compartidos de este mes.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="flex flex-col items-center justify-center py-6 bg-gradient-to-br from-background to-muted/20 rounded-xl border border-border/40">
                            <p className="text-sm text-muted-foreground mb-2 uppercase tracking-wide font-medium">Deuda Pendiente</p>
                            <div className="text-5xl font-bold font-outfit tracking-tighter text-foreground flex items-center gap-2">
                            ...
                            <div className="mt-4 flex items-center gap-3 text-sm">
                                <Badge variant="outline" className="bg-red-500/10 text-red-500 border-red-500/20 px-3 py-1">
                                    {mockReconciliation.debtor} debe pagar
                                </Badge>
                        ...
                        <Dialog>
                            ...
                            <DialogContent className="sm:max-w-[425px]">
                                ...
                                <DialogFooter className="sm:justify-between">
                                    ...
                                    <Button onClick={handleSettleDebt} disabled={isSettling} className="min-w-[120px]">
                        ...
                        <div className="pt-4 border-t border-border/20">
                            <div className="flex justify-between items-center text-sm mb-4">
                                <span className="text-muted-foreground">Gastos Totales Compartidos: <strong className="text-foreground">${mockReconciliation.totalSharedExpenses.toLocaleString()}</strong></span>
                                <span className="text-muted-foreground">Cuota Ideal (50/50): <strong className="text-foreground">${mockReconciliation.fairShare.toLocaleString()}</strong></span>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                        ...
                        <CardContent className="pt-4">
                            <div className="space-y-4">
                                {mockHistory.map((history) => (
                                    <div key={history.id} className="flex items-center justify-between p-3 rounded-lg bg-muted/30 border border-border/20">
                                        ...
                                        <div className="text-right flex flex-col items-end">
                                            ...
                                            <Badge variant="outline" className="text-[9px] h-4 mt-1 bg-background/50">{history.status}</Badge>
                                        </div>
                                    </div>
                                ))}
                            </div>
